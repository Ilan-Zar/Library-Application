class Book {
    ...
    public boolean rentBook(String rentDate, String dueDate, Library library) throws DateFormatException, RentPeriodException {
    	if(this.library == library){
        	...
        	rs.borrowed = true;
        	System.out.println("Rent Request: Successfully rented book!");
        	return true;
        }
        return false;
    }
    ...
    public void returnBook(Library library) {
    	if(this.library == library){
    		rs.borrowed = false;
    		System.out.println("Return Request: Book has been returned!\n");
    	}
    }
    ...
    public boolean isBookOverdue() throws DateFormatException {
	   try{
		Long difference = Helper.timeDifference(Helper.getCurrentDate(), rs.dueDate);
		if(difference > 0.0){
    	   return true;
		 }
	   }catch(DateFormatException e){
    ...
    public String toString() {
        ...
        if(this.library == null){
        	...
        	s = "(" + bookName + ", " + valueTag + " => " + library.libraryName +")" + rs.toString();
        }
        return s;
    }
    ...
    private class RentSettings {
        ...
        //Logic assumed since no specific instructions that dates are set to current date.
        	try{
